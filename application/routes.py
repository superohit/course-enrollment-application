...
from application.course_list import courseList
...
@app.route("/user")
def user():
    # User(user_id=1, first_name="Harry", last_name="Potter", email="harry@potter.com", password="harry@potter").save()
    # User(user_id=2, first_name="Larry", last_name="Google", email="larry@google.com", password="larry@google").save()
